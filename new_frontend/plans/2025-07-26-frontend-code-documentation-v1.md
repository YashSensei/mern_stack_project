# Frontend Code Documentation - Chat App

## Project Overview
This is a React.js frontend application for a real-time chat application built with Vite, TailwindCSS, DaisyUI, and Zustand for state management. The application features user authentication, real-time messaging with WebSocket support, and a modern responsive UI.

## Technology Stack
- **React**: 18.3.1 with functional components and hooks
- **Vite**: Build tool and development server
- **TailwindCSS + DaisyUI**: Styling framework with component library
...
│   ├── HomePage
│   │   ├── Sidebar
│   │   │   └── SidebarSkeleton (conditional)
│   │   ├── NoChatSelected (conditional)
│   │   └── ChatContainer (conditional)
│   │       ├── ChatHeader
│   │       ├── MessageSkeleton (conditional)
│   │       └── MessageInput
│   ├── LoginPage
│   ├── SignUpPage
│   │   └── AuthImagePattern
...
1. **useAuthStore**: Manages authentication, user data, WebSocket connection, and online users
2. **useChatStore**: Handles chat functionality, messages, user selection, and real-time message updates
3. **useThemeStore**: Simple theme persistence using localStorage

### Real-time Communication
- Native WebSocket connection established in `useAuthStore`
- Message handling distributed between auth store (online users) and chat store (messages)
- Event-based architecture with proper subscription/unsubscription patterns

### Key Features
- **Authentication**: Login/signup with form validation
- **Real-time Chat**: WebSocket-based messaging with image support
- **Responsive Design**: Mobile-first approach with TailwindCSS
- **Theme Support**: DaisyUI theme system with persistence
- **Loading States**: Skeleton components for better UX
- **Error Handling**: Toast notifications for user feedback
- **Profile Management**: Avatar upload and profile editing

This documentation provides a complete overview of the frontend codebase with all source files and their implementations.